			...
			<section className="contact">
				<div className="ccont">
					<div className="cleft">
						...
						<h1>How to<span className='primc'> get in<br />touch </span>with us</h1>
					...
					<div className="cright">
						<div className="ccard">
							...
							<h2>Book Online</h2>
							<p>Choose your date and book online now.</p>
						...
						<div className="ccard">
							...
							<h2>Call Us</h2>
							<p>Speak to us over the phone.</p>
							<button className='bkapt'>Call Now</button>
						</div>
						<div className="ccard">
							<div className="sv">
							...
							<button className='bkapt'>Get Directions</button>
						</div>
					</div>
				</div>
